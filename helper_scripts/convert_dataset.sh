					...
					then
						...
						then
							...
							then
								...
								if [ "$DATASET" == "BigLoop5" ]
								then
									SOURCEDIR=/lhome/phlippe/data/ml_data/CNNDataWriter_dumps/cnn_data_writer_dump_20170809_110318_fusion_big_loop_sunnyvale_ave_cw_medium_traffic_with_tl_and_stoplines_dumped/
									FRAMENUMBER="1502302438878145"
									DESTFOLDER=BigLoop5
								else

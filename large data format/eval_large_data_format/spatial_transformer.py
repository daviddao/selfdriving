...
def transformer(U, theta, out_size, name='SpatialTransformer', **kwargs):
    ...
    def _interpolate(im, x, y, out_size):
        with tf.variable_scope('_interpolate'):
            ...
            x = (x + 1.0) / 2.0 * (width_f - 1)
            y = (y + 1.0) / 2.0 * (height_f - 1)
...
def spatial_transformer_network(U, thetas):
	return tf.reshape(transformer(U, thetas, [U.get_shape()[1], U.get_shape()[2]]), U.get_shape())

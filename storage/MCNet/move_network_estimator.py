...
class MCNET(object):
    ...
    def __init__(self, image_size, batch_size=32, c_dim=1,  # Input has to be 2 dimensional: First occupancy, last occlusion map
                 ...
                 useGAN=True, useSharpen=False, data_format='channels_first'):
        ...
        self.pred_occlusion_map = tf.ones(self.occlusion_shape, dtype=tf.float32, name='Pred_Occlusion_Map') * self.predOcclValue
    ...
    def forward(self, input_tensor, motion_maps, ego_motions, tower_id, input_data_format='channels_last'):
        #if self._data_format != input_data_format:
        #    if input_data_format == 'channels_last':
        #        # Computation requires channels_first.
        #        x = tf.transpose(x, [0, 3, 1, 2]) #NEED TO CHECK THIS!!
        #    else:

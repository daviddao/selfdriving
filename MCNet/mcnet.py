"""
Original Motion-Content Network code adjusted for a RGB difference image.

Strongly inspired by https://github.com/rubenvillegas/iclr2017mcnet/blob/master/src/mcnet.py
MIT License - downloaded 07/01/2017

Usage:
  from mcnet.py import MCNET
"""
